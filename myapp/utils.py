...
def get_gardening_advice(question):
    ...
    """
    prompt = (
        f"You are an expert gardener providing professional advice. ONLY answer gardening-related questions. "
        f"If the question is not about gardening, respond with: 'I'm here to help with gardening-related questions only.' "
